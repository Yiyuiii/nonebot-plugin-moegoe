...
jp_cmd = on_regex(
    profileDict["jpapi"]["regex"], block=True, priority=profileDict["priority"]
)
jp2_cmd = on_regex(
    profileDict["jp2api"]["regex"], block=True, priority=profileDict["priority"]
)
kr_cmd = on_regex(
    profileDict["krapi"]["regex"], block=True, priority=profileDict["priority"]
)
cn_cmd = on_regex(
    profileDict["cnapi"]["regex"], block=True, priority=profileDict["priority"]
)
